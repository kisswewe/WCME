        ...
        foreach ($order_list as $order_id => $order_info) {
            ...
            if (is_array($order_info['extend_order_goods'])) {
                foreach ($order_info['extend_order_goods'] as $value) {
                    $goods_common = Model('goods')->where(array('goods_id'=>$value['goods_id']))->field('goods_commonid')->find();
                    $where['goods_commonid'] = $goods_common['goods_commonid'];
                    $result = Model('goods_common')->where($where)->field('integral')->find();
                    $value['integral'] = $result['integral'];
