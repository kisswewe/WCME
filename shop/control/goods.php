...
class goodsControl extends BaseGoodsControl
{
    ...
    public function indexOp()
    {
        ...
        $currency_rate = $model_setting->getListSetting();
        $goods_info['goods_TWD_price'] = $goods_info['goods_price'] * $currency_rate['TWD_rate'] / 100;
        $goods_info['goods_usd_price'] = $goods_info['goods_price'] * $currency_rate['usd_rate'] / 100;
        $goods_info['goods_MYR_price'] = $goods_info['goods_price'] * $currency_rate['MYR_rate'] / 100;
