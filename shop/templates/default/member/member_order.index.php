          ...
          <?php if (is_array($order_info['goods_list'])) { ?>
            <?php foreach ($order_info['goods_list'] as $k => $goods_info) {?>
              ...
              <tr>
                ...
                <td><?php echo $goods_info['integral']; ?></td>
                ...
                <?php if (($order_info['goods_count'] > 1 && $k ==0) || ($order_info['goods_count'] == 1)){?>
                  <td class="bdl" rowspan="<?php echo $order_info['goods_count'];?>"><p class=""><strong><?php echo $order_info['order_amount']; ?><?php echo '+'.$order_info['integral_amount']; ?></strong></p>
