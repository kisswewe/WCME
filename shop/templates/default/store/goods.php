...
<style type="text/css">
  .ncs-goods-summary dl dd.currency{
    display: none;
  }
</style>
    ...
    <div class="ncs-goods-summary">
      <div class="name">
        ...
        <div class="ncs-goods-title-nav">
          <ul id="currency_tab">
            <li data-type="all" class="current"><a href="javascript:void(0);">人民币</a></li>
            <li data-type="1" class=""><a href="javascript:void(0);">美元</a></li>
            <!-- <li data-type="2" class=""><a href="javascript:void(0);">马币</a></li> -->
            <li data-type="3"><a href="javascript:void(0);">新台币</a></li>
          </ul>
        </div>
      <div class="ncs-meta">
        ...
        <dl>
          ...
          <dd class="price currency" style="display: inline-block;">
          ...
          <dd class="price currency">
            <?php if (isset($output['goods']['promotion_price']) && !empty($output['goods']['promotion_price'])) {?>
            <strong><i><?php echo $lang['currency'];?></i><?php echo ncPriceFormat($output['goods']['promotion_price']);?></strong><em>(原售价<?php echo $lang['nc_colon'];?><?php echo $lang['currency'].ncPriceFormat($output['goods']['goods_usd_price']);?>)</em>
            <?php } else {?>
            <strong>＄<?php echo ncPriceFormat($output['goods']['goods_usd_price']);?></strong>
            <?php }?>       
          </dd>
          <!-- <dd class="price currency">
            <?php if (isset($output['goods']['promotion_price']) && !empty($output['goods']['promotion_price'])) {?>
            <strong><i><?php echo $lang['currency'];?></i><?php echo ncPriceFormat($output['goods']['promotion_price']);?></strong><em>(原售价<?php echo $lang['nc_colon'];?><?php echo $lang['currency'].ncPriceFormat($output['goods']['goods_MYR_price']);?>)</em>
            <?php } else {?>
            <strong>MYR <?php echo ncPriceFormat($output['goods']['goods_MYR_price']);?></strong>
            <?php }?>       
          </dd> -->
          <dd class="price currency">
            <?php if (isset($output['goods']['promotion_price']) && !empty($output['goods']['promotion_price'])) {?>
            <strong><i><?php echo $lang['currency'];?></i><?php echo ncPriceFormat($output['goods']['promotion_price']);?></strong><em>(原售价<?php echo $lang['nc_colon'];?><?php echo $lang['currency'].ncPriceFormat($output['goods']['goods_TWD_price']);?>)</em>
            <?php } else {?>
            <strong>NT$ <?php echo ncPriceFormat($output['goods']['goods_TWD_price']);?></strong>
            <?php }?>       
          </dd>
          <dt>积分：</dt>
          <dd class="price"><strong><?php echo $output['goods']['integral'];?></strong></dd>
        </dl>
        <dl class="rate">
          <dt>商品评分：</dt>
          <!-- S 描述相符评分 -->
        ...
        <div class="content">
          <ul>
            ...
            <li>
              ...
              <div class="goods-price">￥<?php echo ncPriceFormat($g['goods_promotion_price']).'+'.$g['integral'];?></div>
            </li>
            <?php } ?>
          </ul>
        </div>
        ...
        <ul>
          ...
          <li>
            <dl>
              ...
              <dd class="goods-price"><?php echo $lang['currency'];?><?php echo $goods_commend['goods_promotion_price'].'+'.$goods_commend['integral'];?></dd>
            </dl>
          </li>
          <?php }?>
          <?php }?>
  ...
  <div class="ncs-goods-main" id="main-nav-holder">
    ...
    <div class="ncg-salelog">
      ...
      <div class="ncs-goods-info-content bd" id="ncGoodsTraded">
        <div class="top">
          <div class="price"><?php echo $lang['goods_index_goods_price'];?><strong><?php echo ncPriceFormat($output['goods']['goods_price']);?></strong>积分<?php echo $lang['goods_index_yuan'];?><strong><?php echo $output['goods']['integral'];?></strong><span><?php echo $lang['goods_index_price_note'];?></span></div>
        </div>
        <!-- 成交记录内容部分 -->
          ...
          <ol>
            ...
            <li>
              <dl>
                ...
                <dd class="price pngFix"><?php echo ncPriceFormat($g['goods_promotion_price']).'+'.$g['integral']; ?></dd>
              </dl>
            </li>
            <?php } ?>
          </ol>
...
//触及显示缩略图
    ...
    //货币列表
    $('#currency_tab').on('click', 'li', function() {
        $('#currency_tab li').removeClass('current');
        $(this).addClass('current');
        $('.currency').hide();
        $('.currency').eq($(this).index()).css('display','inline-block');
    });
