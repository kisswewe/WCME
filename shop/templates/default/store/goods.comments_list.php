        ...
        <div class="content">
          <dl class="ncs-comment-goods">
            ...
            <dd class="goods-pic"><a href="<?php echo urlShop('goods', 'index', array('goods_id' => $output['goods']['goods_id']));?>"> <img src="<?php echo cthumb($output['goods']['goods_image'], 240); ?>" alt="<?php echo $output['goods']['goods_name']; ?>"> </a> </dd>
                        ...
                        <dd class="goods-price"><?php echo $lang['goods_index_goods_price'].$lang['nc_colon'];?><em class="saleP"><?php echo $lang['currency'].$output['goods']['goods_price'].'+'.$output['goods']['integral'];?></em>
                        </dd>
                        <?php } else { ?>
                        <dd class="goods-price"><em class="saleP"><?php echo $lang['show_store_index_no_buy'].'+'.$output['goods']['integral'];?></em>
                        </dd>
                        <?php } ?>
