      ...
      <div <?php if ($i != 0) {?>style="display: none;"<?php }?> data-id="<?php echo $val['id'];?>">
        <ul class="ncs-bundling-list">
          ...
          <li>
            ...
            <dl>
              ...
              <dd>原&nbsp;&nbsp;&nbsp;&nbsp;价：<em class="o-price"><?php echo $lang['currency'].ncPriceFormat($v['shop_price']).'+'.$v['integral'];?></em></dd>
              <dd>优惠价：<em class="b-price"><?php echo $lang['currency'].ncPriceFormat($v['price']).'+'.$v['integral'];?></em></dd>
            </dl>
        ...
        <ul>
          <li>已选套装：<strong><?php echo $val['name'];?></strong></li>
            <li>套装原价：<em><?php echo $lang['currency'].ncPriceFormat($val['cost_price']).'+'.$val['integral'];?></em></li>
            <li>优惠价格：<em class="bundling-price"><?php echo $lang['currency'].ncPriceFormat($val['price']).'+'.$val['integral'];?></em></li>
