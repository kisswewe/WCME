...
<?php } ?> /></td>
          ...
          <td><!-- S 商品单价 -->
            ...
            <!-- S 商品促销-抢购 --></td>
          <td> <em id="item<?php echo $cart_info['cart_id']; ?>_integral" class="goods-price" nc_type="eachGoodsTotal_integral"><?php echo $cart_info['goods_num']*$cart_info['integral']; ?></em> </td>
      ...
      <tfoot>
        <tr>
          <td colspan="20"><div class="ncc-all-account"><?php echo $lang['cart_index_goods_sumary'];?><em id="cartTotal"><?php echo $output['cart_totals']; ?></em><?php echo $lang['currency_zh'];?>总积分<em id="integraltotal"><?php echo $cart_info['integral'];?></em></div>
