...
<div class="ncc-receipt-info">
  ...
  <div id="addr_list" class="ncc-candidate-items">
    <ul>
      <li><span class="true-name"><?php echo $output['address_info']['true_name'];?></span><span class="address"><?php echo $output['address_info']['area_info'],$output['address_info']['address'];?></span><span class="phone"><i class="icon-mobile-phone"></i><?php echo $output['address_info']['mob_phone'] ?$output['address_info']['phone_country_code'].'-'.$output['address_info']['mob_phone'] : $output['address_info']['tel_country_code'].'-'.$output['address_info']['tel_phone'];?></span></li>
    </ul>
  </div>
</div>
