    ...
    <tbody>
      ...
      <tr id="cart_item" class="shop-list <?php echo ($cart_info['state'] && $cart_info['storage_state']) ? '' : 'item_disabled';?>">
        ...
        <td><em class="goods-price">定金：<?php echo $cart_info['book_down_payment'];?></em>
         ...
         <td><em class="goods-price"><?php echo $cart_info['goods_num']*$cart_info['integral'];?></em></td>
        ...
        <td colspan="20"><div class="ncc-msg">买家留言：
          ...
          <div class="ncc-store-account">
            <dl>
              ...
              <dd class="sum"><em nc_type="eachStoreFreight" id="111eachStoreFreight_<?php echo $store_id;?>"><?php echo $output['store_integral_total'][$store_id];?></em></dd>
            </dl>
            <dl>
              <dt>物流运费：</dt>
