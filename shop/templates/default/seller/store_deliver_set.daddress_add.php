  ...
  <form method="post" action="index.php?act=store_deliver_set&op=daddress_add" id="address_form" target="_parent">
    ...
    <dl>
      ...
      <dd>
                        ...
                        <?php foreach ($output['code'] as $v) { ?>
                            <option value="<?php echo trim($v['international_code'])?>"><?php echo $v['chinese_name'] . '&nbsp&nbsp&nbsp&nbsp +' .trim($v['international_code']); ?></option>
                        <?php } ?>
                    </select>
