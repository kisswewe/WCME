        ...
        <dd class="opt">
          <ul class="ncap-account-container-list">
            <?php if($output['list_setting']['hao_sms_type']==1){ ?>
                <li>
                    <input type="radio" name="hao_sms_type" value="3" />
                    <label for="hao_sms_type">创蓝文化</label>
                </li>
          <li>
          ...
          <?php }elseif($output['list_setting']['hao_sms_type']==2){ ?>
                <li>
                    <input type="radio" name="hao_sms_type" value="3" />
                    <label for="hao_sms_type">创蓝文化</label>
                </li>
          ...
          <?php }else{?>
                <li>
                    <input type="radio" name="hao_sms_type" value="3" checked="checked" />
                    <label for="hao_sms_type">创蓝文化</label>
                </li>
                <li>
                    <input type="radio" name="hao_sms_type" value="1" />
                    <label for="hao_sms_type"><?php echo $lang['hao_sms_dxb'];?></label>
                </li>
                <li>
                    <input type="radio" name="hao_sms_type" value="2" />
