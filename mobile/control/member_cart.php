...
class member_cartControl extends mobileMemberControl {
    ...
    public function cart_listOp() {
        ...
        foreach ($cart_list as $cart) {
            ...
            $cart['integral_total'] = ncPriceFormat($cart['integral'] * $cart['goods_num']);
            ...
            $sum_integral += $cart['integral_total'];
        }
        ...
        output_data(array('cart_list' => array_values($store_cart_list), 'sum_integral' => ncPriceFormat($sum_integral), 'sum' => ncPriceFormat($sum), 'cart_count' => count($cart_list)));
    }
