...
class cartModel extends Model {
     ...
     */
    public function addCart($data = array(), $save_type = '', $quantity = null,$integral = '') {
        $method = '_addCart'.ucfirst($save_type);
        $insert = $this->$method($data,$quantity,$integral);
     ...
     * @return unknown
     */
    private function _addCartDb($goods_info = array(),$quantity,$integral) {
        //验证购物车商品是否已经存在
        $condition = array();
     ...
     * @return unknown
     */
    private function _addCartCookie($goods_info = array(), $quantity = null,$integral) {
        //去除斜杠
