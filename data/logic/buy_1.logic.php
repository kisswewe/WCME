...
class buy_1Logic {
    ...
    public function calcCartList($store_cart_list) {
        ...
        foreach ($store_cart_list as $store_id => $store_cart) {
            ...
            foreach ($store_cart as $key => $cart_info) {
                        $store_cart[$key]['integral_total'] = ncPriceFormat($cart_info['integral'] * $cart_info['goods_num']);
                ...
                $integral += $store_cart[$key]['integral_total'];
            }
            $store_cart_list[$store_id] = $store_cart;
            $store_goods_total[$store_id] = ncPriceFormat($tmp_amount);
            $store_integral_total[$store_id] =$integral;
        }
        return array($store_cart_list,$store_goods_total,$store_integral_total);
    }
    ...
    private function _getGoodsOnlineInfo($goods_id,$quantity) {
        ...
        $new_array['bl_id'] = 0;
        $new_array['integral'] = $goods_common['integral'];
