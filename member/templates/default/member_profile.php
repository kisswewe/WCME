        ...
        <dl>
          ...
          <input type="hidden" name="region" id="region" value="<?php echo $output['member_info']['member_areainfo']; ?>" /></span><span>
            <select name="privacy[area]">
              <option value="3" <?php if($output['member_info']['member_privacy']['area'] == 3){?>selected="selected"<?php }?>><?php echo $lang['home_member_public'];?></option>
...
//注册表单验证
$(function(){
	$("#region").nc_region({show_deep:4,btn_style_html:'style="background-color: #F5F5F5; width: 60px; height: 32px; border: solid 1px #E7E7E7; cursor: pointer"'});
