  ...
  <table class="ncm-default-table" >
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td><p><i class="icon-phone"></i><?php echo $address['tel_phone']?$address['tel_country_code'].'-'.$address['tel_phone']:'';?></p>
          <p><i class="icon-mobile-phone"></i><?php echo $address['mob_phone']?$address['phone_country_code'].'-'.$address['mob_phone']:''; ?></p></td>
